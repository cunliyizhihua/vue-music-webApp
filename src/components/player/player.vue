<template>
  <div class="player" v-show="playlist.length>0">
    ...
    <audio ref="audio" :src="currentSong.url" @ended="end"
      @play="ready" @error="error" @timeupdate="updateTime"></audio>
  </div>
</template>
  ...
  export default{
    ...
    methods: {
      ...
      middleTouchMove(e) {
        ...
        // 假如屏幕宽度320    [=> deltaX > 0]
        // 当cd界面 left=0    [如果=> width=0]          / [如果<= -320 < width < 0]
        // 当ly界面 left=-320 [如果=> -320 < width < 0] / [如果 <= width = -320]
      ...
      middleTouchEnd() {
        ...
        let width
        let opacity
        // 在cd界面 向右移动超过10% 歌词偏移一个屏幕的宽度 cd隐藏
